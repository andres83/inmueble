...
class AdcpDb {
    ...
    public static function getDbConn($dbParams = null) {
        if ($dbParams !== null) {
            ...
            $host = ADCP_DB_HOST;
            $username = ADCP_DB_USERNAME;
            $password = ADCP_DB_PASSWORD;
            $dbName = ADCP_DB_DBNAME;
        }
    ...
    public function sanitizeInput(&$var) {
        if (is_array($var)) {
            ...
            if (get_magic_quotes_gpc() == 1) {
                $var = trim(mysql_real_escape_string(stripslashes($var)));
            } else {
    ...
    /**
     * Returns new AdcpDbTableSelect object with default table and SQL * Wildcard
     *
     * @param array         $cols column names
     * @param string        $table table name
     * @return object       AdcpDbTableSelect object
     */
    public function select($cols = null, $table = null) {
        ...
        return new AdcpDbTableSelect($table, $cols);
    }
     ...
     *
     * @param mixed        $sql query or AdcpDbTableSelect object
     * @return mixed
     */
     ...
     *
     * @param mixed             $data (AdcpDbTableSelect or PHP resource
     * @return int
     */
    public function numRows($select) {
        if ($select instanceof AdcpDbTableSelect) {
     ...
     *
     * @param mixed $select AdcpDbTableSelect or resource
     * @param int $colIndex
     * @return mixed
     */
